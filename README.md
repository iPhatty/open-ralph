...
Ralph is an autonomous AI agent loop that runs repeatedly until all PRD items are complete. Each iteration is a fresh Amp instance with clean context. Memory persists via git history, `progress.txt`, and `prd.json`.
...
- The prompt.md & prd/SKILL.md depends on [playwright-mcp](https://github.com/microsoft/playwright-mcp), you can implement this or change to your choice of FE validation  
